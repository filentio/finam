...
class Settings(BaseSettings):
    ...
    @field_validator("COVER_LETTER_FORBIDDEN_PHRASES", mode="before")
    @classmethod
    def _parse_cover_letter_forbidden_phrases(cls, v):
        # Accept unset / empty string and treat as None.
        if v is None:
            return None
        if v == "":
            return None
