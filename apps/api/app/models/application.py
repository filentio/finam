...
class Application(Base):
    ...
    sync_error_code: Mapped[str | None] = mapped_column(String, nullable=True)
    sync_error_text: Mapped[str | None] = mapped_column(Text, nullable=True)
