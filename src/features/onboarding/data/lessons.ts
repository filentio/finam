...
const LESSON_2: LessonConfig = {
  ...
  screens: [
    ...
    },
    {
      ...
      content:
        "Снижение рисков начинается с дисциплины. Важно заранее определить правила и не нарушать их на эмоциях.",
      key_points: [
        "Используйте стоп-лоссы для защиты капитала.",
        "Для старта выбирайте более надёжные инструменты, например ОФЗ.",
        "Инвестируйте на долгий срок (обычно от 3 лет).",
        "Не продавайте в панике при просадках рынка.",
      ],
    },
    {
      screen_id: "2_4",
...
const LESSON_4: LessonConfig = {
  ...
  screens: [
    ...
    },
    {
      ...
      subtitle:
        "Рекомендации рассчитаны для старта. После анкеты риска рекомендации персонализируются.",
    },
    {
      screen_id: "4_3",
      type: "cta",
...
const LESSON_5: LessonConfig = {
  ...
  screens: [
    ...
    },
    {
      ...
      subtitle:
        "Рекомендация зависит от вашего стиля торговли. Тариф можно менять без ограничений.",
    },
    {
      screen_id: "5_3",
      type: "calculator",
