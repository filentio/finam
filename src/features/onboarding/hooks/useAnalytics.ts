...
export const ANALYTICS_EVENTS = {
  ...
  RISK_QUIZ_INTRO_COMPLETED: "risk_quiz_intro_completed",
  RISK_QUIZ_QUESTION_VIEWED: "risk_quiz_question_viewed",
  RISK_QUIZ_ANSWER_SELECTED: "risk_quiz_answer_selected",
  RISK_QUIZ_ANSWER_SUBMITTED: "risk_quiz_answer_submitted",
  RISK_QUIZ_COMPLETED: "risk_quiz_completed",
  RISK_QUIZ_RESULT_VIEWED: "risk_quiz_result_viewed",
  RISK_QUIZ_CONTINUE_CLICKED: "risk_quiz_continue_clicked",
